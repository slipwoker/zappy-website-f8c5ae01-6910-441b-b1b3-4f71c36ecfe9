  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, errorType) {
      ...
      const messages = {
        ...
        minlength: 'Please enter at least ' + (field.getAttribute('minlength') || '1') + ' characters.'
      };
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f8c5ae01-6910-441b-b1b3-4f71c36ecfe9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f8c5ae01-6910-441b-b1b3-4f71c36ecfe9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f8c5ae01-6910-441b-b1b3-4f71c36ecfe9';
